    ...
    return (
        <div>
            <form className="  rounded px-8 pt-6 pb-8 mb-4 d-grid md:grid-cols-2 md:justify-items-center ml-20 gap-y-0">
                ...
                <button className="bg-amber-300 w-110 hover:bg-grey-500 rounded-xl w-200  p-2 font-card hover:text-white hover:bg-gray-500 hover:border-gray-300 duration-300 mt-30 ">Confirmar</button>
